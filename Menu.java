...
public class Menu {
    ...
    private static Entidade nova_entidade;
    ...
    public void registar_empresa(int nif, String nome, String email, String morada, String pass){
        clear();
        Scanner in = new Scanner(System.in);
        out("\nQuantas atividades a sua empresa esta associada? ");
        int numact = in.nextInt();
        ArrayList<Integer> activ = new ArrayList<Integer>(numact);
        if ( numact > 0 ){
            for (Integer i : activ){
                out ("\nDigite umas das atividades");
                activ.add(in.nextInt());
            }
        }
    }
    
    public void registar_individual(int nif, String nome, String email, String morada, String pass){
        clear();
        Scanner in = new Scanner(System.in);
